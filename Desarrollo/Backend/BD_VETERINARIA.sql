...
CREATE TABLE TB_FICHA_MEDICA(
    ...
    CONSTRAINT FK_MASCOTA02 FOREIGN KEY(ID_MASCOTA) REFERENCES TB_MASCOTAS(ID_MASCOTA) ON DELETE CASCADE
);
...
INSERT INTO TB_FICHA_MEDICA(ID_FICHA, ID_MASCOTA, FECHA_CREACION, ANTECEDENTES, GRUPO_SANGUINEO,
							DIAGNOSTICO, TRATAMIENTO)
VALUES(1, 1, NOW(), 'No tiene ningun tipo de alergias o enfermedades diagnosticadas anteriormente', 'A+', 
...
CREATE VIEW VW_HISTORIAL_FICHAS
AS 
SELECT 
...
FROM 
	TB_FICHA_MEDICA F INNER JOIN TB_MASCOTAS M 
...
ALTER TABLE TB_AUDITA_CITAS
ADD CONSTRAINT FK_CITA01 FOREIGN KEY (ID_CITA) REFERENCES TB_CITAS(ID_CITA),
ADD CONSTRAINT FK_MASCOTA03 FOREIGN KEY (ID_MASCOTA) REFERENCES TB_MASCOTAS(ID_MASCOTA);
...
ALTER TABLE TB_AUDITA_FICHA_MEDICA
ADD CONSTRAINT FK_FICHA01 FOREIGN KEY (ID_FICHA) REFERENCES TB_FICHA_MEDICA(ID_FICHA),
ADD CONSTRAINT FK_MASCOTA04 FOREIGN KEY (ID_MASCOTA) REFERENCES TB_MASCOTAS(ID_MASCOTA);
